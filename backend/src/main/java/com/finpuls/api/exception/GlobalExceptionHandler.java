...
import com.finpuls.api.response.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Обработка FinPulsException и его наследников
     */
    @ExceptionHandler(FinPulsException.class)
    public ResponseEntity<ApiResponse<?>> handleFinPulsException(FinPulsException ex) {
        log.error("Исключение FinPuls: {} - {}", ex.getErrorCode(), ex.getMessage(), ex);
     ...
     */
    private HttpStatus determineHttpStatus(FinPulsException ex) {
